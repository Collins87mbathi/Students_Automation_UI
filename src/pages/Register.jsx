      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={fetchData}>
          ...
          <div>
            <button
              type="submit"
              className="group relative flex w-full justify-center rounded-md border border-transparent bg-blue-500 py-2 px-4 text-sm font-medium text-white hover:bg-[#40AA54]-700 focus:outline-none focus:ring-2 focus:ring-[#40AA54]-500 focus:ring-offset-2"
            >
        ...
        <div className='flex items-center flex-col gap-2'>
          <Link to='/login'>Got an account? <font className='text-blue-500 font-semibold'>login</font></Link>
